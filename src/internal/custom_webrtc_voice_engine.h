...
#ifndef INTERNAL_CUSTOM_MEDIA_ENGINE_WEBRTC_VOICE_ENGINE_H_
#define INTERNAL_CUSTOM_MEDIA_ENGINE_WEBRTC_VOICE_ENGINE_H_
...
class CreateAudioStateFactory {
 public:
  virtual ~CreateAudioStateFactory() = default;
  virtual rtc::scoped_refptr<webrtc::AudioState> CreateAudioState(
      const webrtc::AudioState::Config& config) = 0;
};
}  // namespace webrtc
...
// CustomWebRtcVoiceEngine is a class to be used with CompositeMediaEngine.
// It uses the WebRtc VoiceEngine library for audio handling.
class CustomWebRtcVoiceEngine final : public VoiceEngineInterface {
  friend class WebRtcVoiceSendChannel2;
  friend class WebRtcVoiceReceiveChannel2;
 ...
 public:
  ...
  CustomWebRtcVoiceEngine() = delete;
  CustomWebRtcVoiceEngine(const CustomWebRtcVoiceEngine&) = delete;
  CustomWebRtcVoiceEngine& operator=(const CustomWebRtcVoiceEngine&) = delete;

  ~CustomWebRtcVoiceEngine() override;
  ...
  std::unique_ptr<VoiceMediaSendChannelInterface> CreateSendChannel(
      webrtc::Call* call, const MediaConfig& config,
 ...
 private:
  ...
  webrtc::CreateAudioStateFactory* create_audio_state_factory_;
...
class WebRtcVoiceSendChannel2 final : public MediaChannelUtil,
                                      public VoiceMediaSendChannelInterface {
 public:
  WebRtcVoiceSendChannel2(CustomWebRtcVoiceEngine* engine,
  ...
  WebRtcVoiceSendChannel2() = delete;
  WebRtcVoiceSendChannel2(const WebRtcVoiceSendChannel2&) = delete;
  WebRtcVoiceSendChannel2& operator=(const WebRtcVoiceSendChannel2&) = delete;

  ~WebRtcVoiceSendChannel2() override;
  ...
  bool SetAudioSend(uint32_t ssrc, bool enable, const AudioOptions* options,
 ...
 private:
  ...
  CustomWebRtcVoiceEngine* engine() { return engine_; }
  ...
  CustomWebRtcVoiceEngine* const engine_ = nullptr;
  std::vector<AudioCodec> send_codecs_;
...
class WebRtcVoiceReceiveChannel2 final
    : public MediaChannelUtil,
      public VoiceMediaReceiveChannelInterface {
 public:
  WebRtcVoiceReceiveChannel2(CustomWebRtcVoiceEngine* engine,
                             const MediaConfig& config,
                             const AudioOptions& options,
                             const webrtc::CryptoOptions& crypto_options,
                             webrtc::Call* call,
  ...
  WebRtcVoiceReceiveChannel2() = delete;
  WebRtcVoiceReceiveChannel2(const WebRtcVoiceReceiveChannel2&) = delete;
  WebRtcVoiceReceiveChannel2& operator=(const WebRtcVoiceReceiveChannel2&) =
      delete;

  ~WebRtcVoiceReceiveChannel2() override;
  ...
  void SetRawAudioSink(
      uint32_t ssrc, std::unique_ptr<webrtc::AudioSinkInterface> sink) override;
...
#endif  // INTERNAL_CUSTOM_MEDIA_ENGINE_WEBRTC_VOICE_ENGINE_H_
