...
{
    libwebrtc::scoped_refptr<RTCPeerConnectionFactory> rtc_peerconnection_factory =
      libwebrtc::scoped_refptr<RTCPeerConnectionFactory>(
          new libwebrtc::RefCountedObject<RTCPeerConnectionFactoryImpl>());
...
) noexcept
{
    ...
    libwebrtc::scoped_refptr<RTCPeerConnectionFactory> pFactory = static_cast<RTCPeerConnectionFactory*>(factory);
    ...
    rtcPeerConnectionHandle* pRetVal) noexcept
{
    ...
    libwebrtc::scoped_refptr<RTCPeerConnectionFactory> pFactory = static_cast<RTCPeerConnectionFactory*>(factory);
    libwebrtc::scoped_refptr<RTCMediaConstraints> media_constraints = (constraints == nullptr)
        ? RTCMediaConstraints::Create()
        : libwebrtc::scoped_refptr<RTCMediaConstraints>(static_cast<RTCMediaConstraints*>(constraints));
    libwebrtc::scoped_refptr<RTCPeerConnection> peer_connection = pFactory->Create(rtcConfig, media_constraints);
...
) noexcept
{
    ...
    libwebrtc::scoped_refptr<RTCPeerConnectionFactory> pFactory = static_cast<RTCPeerConnectionFactory*>(factory);
    libwebrtc::scoped_refptr<RTCPeerConnection> peer_connection = static_cast<RTCPeerConnection*>(handle);
...
) noexcept
{
    ...
    libwebrtc::scoped_refptr<RTCPeerConnectionFactory> pFactory = static_cast<RTCPeerConnectionFactory*>(factory);
    libwebrtc::scoped_refptr<RTCAudioDevice> audio_device = pFactory->GetAudioDevice();
...
) noexcept
{
    ...
    libwebrtc::scoped_refptr<RTCPeerConnectionFactory> pFactory = static_cast<RTCPeerConnectionFactory*>(factory);
    libwebrtc::scoped_refptr<RTCVideoDevice> video_device = pFactory->GetVideoDevice();
...
) noexcept
{
    ...
    libwebrtc::scoped_refptr<RTCPeerConnectionFactory> pFactory = static_cast<RTCPeerConnectionFactory*>(factory);
    libwebrtc::scoped_refptr<RTCDesktopDevice> desktop_device = pFactory->GetDesktopDevice();
...
) noexcept
{
    ...
    libwebrtc::scoped_refptr<RTCPeerConnectionFactory> pFactory = static_cast<RTCPeerConnectionFactory*>(factory);
    libwebrtc::scoped_refptr<RTCAudioSource> audio_source = pFactory->CreateAudioSource(string(audio_source_label));
...
) noexcept
{
    ...
    libwebrtc::scoped_refptr<RTCDummyAudioSource> audio_source = pFactory->CreateDummyAudioSource(
...
) noexcept
{
    ...
    libwebrtc::scoped_refptr<RTCPeerConnectionFactory> pFactory = static_cast<RTCPeerConnectionFactory*>(factory);
    libwebrtc::scoped_refptr<RTCVideoCapturer> video_capturer = static_cast<RTCVideoCapturer*>(capturer);
    /// A null value is accepted for 'constraints'.
    libwebrtc::scoped_refptr<RTCMediaConstraints> media_constraints = static_cast<RTCMediaConstraints*>(constraints);
    libwebrtc::scoped_refptr<RTCVideoSource> video_source = pFactory->CreateVideoSource(video_capturer, string(video_source_label), media_constraints);
...
) noexcept
{
    ...
    libwebrtc::scoped_refptr<RTCPeerConnectionFactory> pFactory = static_cast<RTCPeerConnectionFactory*>(factory);
    libwebrtc::scoped_refptr<RTCDesktopCapturer> desktop_capturer = static_cast<RTCDesktopCapturer*>(capturer);
    /// A null value is accepted for 'constraints'.
    libwebrtc::scoped_refptr<RTCMediaConstraints> media_constraints = static_cast<RTCMediaConstraints*>(constraints);
    libwebrtc::scoped_refptr<RTCVideoSource> video_source = pFactory->CreateDesktopSource(desktop_capturer, string(video_source_label), media_constraints);
    ...
    rtcDummyVideoCapturerHandle* pRetVal) noexcept
{
    ...
    libwebrtc::scoped_refptr<RTCPeerConnectionFactory> pFactory = static_cast<RTCPeerConnectionFactory*>(factory);
    libwebrtc::scoped_refptr<RTCDummyVideoCapturer> pDummyVideoCapturer = pFactory->CreateDummyVideoCapturer(
        fps, width, height
    );
    ...
    rtcVideoSourceHandle* pRetVal) noexcept
{
    ...
    libwebrtc::scoped_refptr<RTCPeerConnectionFactory> pFactory = static_cast<RTCPeerConnectionFactory*>(factory);
    libwebrtc::scoped_refptr<RTCDummyVideoCapturer> pDummyVideoCapturer = static_cast<RTCDummyVideoCapturer*>(capturer);
    libwebrtc::scoped_refptr<RTCVideoSource> pVideoSource = pFactory->CreateDummyVideoSource(
        pDummyVideoCapturer,
...
) noexcept
{
    ...
    libwebrtc::scoped_refptr<RTCPeerConnectionFactory> pFactory = static_cast<RTCPeerConnectionFactory*>(factory);
    libwebrtc::scoped_refptr<RTCAudioSource> audio_source = static_cast<RTCAudioSource*>(source);
    libwebrtc::scoped_refptr<RTCAudioTrack> audio_track = pFactory->CreateAudioTrack(audio_source, string(track_id));
...
) noexcept
{
    ...
    libwebrtc::scoped_refptr<RTCDummyAudioSource> audio_source = static_cast<RTCDummyAudioSource*>(source);
    libwebrtc::scoped_refptr<RTCAudioTrack> audio_track = pFactory->CreateAudioTrack(audio_source, string(track_id));
...
) noexcept
{
    ...
    libwebrtc::scoped_refptr<RTCPeerConnectionFactory> pFactory = static_cast<RTCPeerConnectionFactory*>(factory);
    libwebrtc::scoped_refptr<RTCVideoSource> video_source = static_cast<RTCVideoSource*>(source);
    libwebrtc::scoped_refptr<RTCVideoTrack> video_track = pFactory->CreateVideoTrack(video_source, string(track_id));
...
) noexcept
{
    ...
    libwebrtc::scoped_refptr<RTCPeerConnectionFactory> pFactory = static_cast<RTCPeerConnectionFactory*>(factory);
    libwebrtc::scoped_refptr<RTCMediaStream> media_stream = pFactory->CreateStream(string(stream_id));
...
) noexcept
{
    ...
    libwebrtc::scoped_refptr<RTCPeerConnectionFactory> pFactory = static_cast<RTCPeerConnectionFactory*>(factory);
    libwebrtc::scoped_refptr<RTCRtpCapabilities> rtp_capabilities = pFactory->GetRtpSenderCapabilities(media_type);
...
) noexcept
{
    ...
    libwebrtc::scoped_refptr<RTCPeerConnectionFactory> pFactory = static_cast<RTCPeerConnectionFactory*>(factory);
    libwebrtc::scoped_refptr<RTCRtpCapabilities> rtp_capabilities = pFactory->GetRtpReceiverCapabilities(media_type);
